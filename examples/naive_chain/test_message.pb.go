...
const file_examples_naive_chain_test_message_proto_rawDesc = "" +
	"\n" +
	"'examples/naive_chain/test_message.proto\x12\x05naive\">\n" +
	"\n" +
	"FwdMessage\x12\x16\n" +
	"\x06sender\x18\x01 \x01(\x04R\x06sender\x12\x18\n" +
	"\apayload\x18\x02 \x01(\fR\apayloadB/Z-github.com/hyperledger-labs/SmartBFT/v2/naiveb\x06proto3"
